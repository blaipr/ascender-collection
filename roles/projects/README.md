...
|Variable Name|Default Value|Required|Type|Description|
|:---:|:---:|:---:|:---:|:---|
|`controller_configuration_async_retries`|50|no|str|This variable sets the number of retries to attempt for the role globally.|
  ...
  pre_tasks:
    - name: Include vars from controller_configs directory
      ansible.builtin.include_vars:
        ...
        extensions: ["yml"]
  roles:
    - {role: ctrliq.ascender.projects, when: controller_projects is defined}
```

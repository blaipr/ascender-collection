# ctrliq.ascender.collect_async_status
...
|`controller_configuration_collect_logs`|`false`|no|When enabled collects error messages and continues execution. Messages are collected in a variable called `controller_configuration_role_errors`|

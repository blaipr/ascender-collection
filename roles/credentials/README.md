...
To get a list of all the available builtin credential types, [checkout the ansible doc's link here](https://docs.ansible.com/automation-controller/4.4/html/userguide/credentials.html#credential-types)
  ...
  pre_tasks:
    - name: Include vars from controller_configs directory
      ansible.builtin.include_vars:
        ...
        extensions: ["yml"]
  roles:
    - {role: ctrliq.ascender.credentials, when: controller_credentials is defined}
```
